package com.syphan.financial.app.controller.app.transaction

import com.syphan.financial.app.controller.app.transaction.request.CreateTransactionRequest
...
@RestController
@RequestMapping(ApiPathConstants.TRANSACTIONS.CRATE)
