package com.syphan.financial.app.controller.transaction

import com.syphan.financial.app.controller.transaction.request.CreateTransactionRequest
...
@RestController
@RequestMapping(PathConstants.TRANSACTIONS.CRATE)
